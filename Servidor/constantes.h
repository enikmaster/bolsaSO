...
#define INFO_COMPRA _T("[INFO] Compra de ações da empresa %s efetuada com sucesso\n")
...
// Estrutura que detalha transações de compra ou venda
...
// Estrutura de mecanismos de sincronização
struct Sync {
    HANDLE hMtxBolsa;
